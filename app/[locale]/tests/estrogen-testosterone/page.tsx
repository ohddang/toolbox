          ...
          <div className="mx-auto max-w-7xl px-6 py-4">
            <div className="flex items-center justify-between">
              <Link href={`/${locale}`} className="flex items-center gap-2 md:gap-3 group">
                <div className="flex h-8 w-8 md:h-10 md:w-10 items-center justify-center rounded-xl md:rounded-2xl bg-gradient-to-br from-pink-400 to-blue-500 shadow-md group-hover:scale-110 transition-transform">
                  <span className="text-lg md:text-xl">🧰</span>
                </div>
                <h1 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-pink-600 to-blue-600 bg-clip-text text-transparent">
                  Toolbag
                </h1>
              </Link>
              <div className="flex items-center gap-2 md:gap-4">
                ...
                <Link
                  href={`/${locale}`}
                  className="rounded-full bg-pink-50 px-3 py-2 md:px-5 text-xs md:text-sm font-bold text-pink-600 transition-all hover:bg-pink-100 hover:scale-105"
                >
                  ← {isKorean ? "돌아가기" : "Back"}
                </Link>
              </div>
